...
highlight LineNr        cterm=italic ctermfg=black ctermbg=lightblue  gui=italic guifg=black guibg=white 

" Syntax highlighting scheme
highlight Comment	    cterm=italic ctermfg=black ctermbg=white gui=italic guifg=#979899 guibg=lightblue 

highlight Constant	    ctermfg=black ctermbg=lightblue guifg=black guibg=lightblue 
highlight String	    ctermfg=black ctermbg=lightblue guifg=#FF5959 guibg=lightblue
...
highlight Identifier	ctermfg=black ctermbg=lightblue  guifg=#3333FF guibg=lightblue
highlight Function	    ctermfg=black ctermbg=lightblue  guifg=#3333FF guibg=lightblue
...
highlight SpecialComment cterm=italic ctermfg=black ctermbg=lightblue  gui=italic guifg=#656666 guibg=lightblue
